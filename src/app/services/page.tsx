...
const SERVICES = [
  {
    title: "محتوى متخصص",
    body: "مقالات ودراسات حالة في مجالات الأعمال والتسويق والريادة وتطوير الذات.",
  },
  {
    title: "استشارات ورؤى",
    body: "ناقش مشروعك أو فكرتك معنا — نستقبل الرؤى الخاصة ونرد عليها.",
  },
  {
    title: "إجابة الاستفسارات",
    body: "اطرح سؤالك في أي مجال يخص محتوى المدونة وسنرد بأسرع وقت.",
  },
];
