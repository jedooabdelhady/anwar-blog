  ...
  return (
    <PageShell active="/about">
      <article className="mx-auto max-w-3xl px-5 sm:px-8 py-10">
        <h1 className="text-3xl sm:text-4xl font-bold text-pepper mb-6">عن علم تأويل الرؤى</h1>
        <p className="text-pepper/85 leading-loose mb-4">
          علم تأويل الرؤى مساحة عربية تجمع بين علم التفسير والمعرفة الثرية، تقدّم محتوى متخصصاً
